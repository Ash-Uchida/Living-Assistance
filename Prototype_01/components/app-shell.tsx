...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  if (!store.ready || (!signedIn && !onSignIn) || (signedIn && onSignIn)) {
    return (
      <div className="flex min-h-full items-center justify-center bg-cream text-sm text-slate-500">
        Loading…
      </div>
    );
  }
  ...
  return (
    <div className="flex min-h-full flex-col bg-cream text-slate-800">
